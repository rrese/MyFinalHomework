...
public class WeatherDisplay extends Activity implements Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            cityname.setText(weaItem.getCity());
    ...
    public void addclick(View v) {
        ...
        WeaDBManager weadbManager = new WeaDBManager(WeatherDisplay.this);
        WeatherItem weaItem = weadbManager.findByCityName(city);
        UserDBManager userdbManager = new UserDBManager(WeatherDisplay.this);
        UserCityItem usercityItem = userdbManager.findByCityName(city);
        if(usercityItem!=null){
            Toast.makeText(this, "已加入我的城市!", Toast.LENGTH_SHORT).show();
        }else{
            UserCityItem userItem = new UserCityItem();
            userItem.setCity(weaItem.getCity());
            userItem.setWeather(weaItem.getWeather());
            userItem.setTem(weaItem.getTem());
            userdbManager.add(userItem);
            Toast.makeText(this, "已加入我的城市!", Toast.LENGTH_SHORT).show();
        }
    }
}